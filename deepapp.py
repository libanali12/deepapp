...
def main():
    ...
    if choice == "Home":
        ...
        PhysicalHealth = st.sidebar.slider('PhysicalHealth', x.PhysicalHealth.min(), x.PhysicalHealth.max(), x.PhysicalHealth.mean())
        MentalHealth = st.sidebar.slider('MentalHealth', x.MentalHealth.min(), x.MentalHealth.max(), x.MentalHealth.mean())
        SleepTime = st.sidebar.slider('SleepTime', x.SleepTime.min(), x.SleepTime.max(), x.SleepTime.mean())
