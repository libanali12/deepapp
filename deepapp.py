...
def main():
    ...
    if choice == "Home":
        ...
        BMI = st.sidebar.slider('BMI', min_value=x.BMI.min(),max_value=x.BMI.max(),step=float(x.BMI.mean()))
        PhysicalHealth = st.sidebar.slider('PhysicalHealth',min_value=x.PhysicalHealth.min(), max_value=x.PhysicalHealth.max(), step=float(x.PhysicalHealth.mean()))
        MentalHealth = st.sidebar.slider('MentalHealth',min_value= x.MentalHealth.min(),max_value= x.MentalHealth.max(),step=float(x.MentalHealth.mean()))
        SleepTime = st.sidebar.slider('SleepTime', min_value=x.SleepTime.min(),max_value= x.SleepTime.max(),step=float(x.SleepTime.mean()))
